...
export default function Server({name, active, users, tier, credits}: ServerProps) {
        ...
        <div className="flex-1">
          <div className="flex flex-row justify-between flex-grow-0">
            <div className="flex flex-col w-64">
              <p>{name}</p>
              <div className={clsx("flex flex-row gap-x-1 whitespace-nowrap", active ? "text-green-300" : "text-red-300 ")}>
                <DiscordLogoIcon className="translate-y-1/3" />
                <p>Discribe {active ? "activated" : "sleeping"}</p>
              </div>
            </div>
            <div className="flex flex-col uppercase w-[16px]">
