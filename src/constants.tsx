export const HERO_SPLASH = "the super fast discord transcription service";
export const SIGN_IN_HINT = "Sign in with your Discord account to add to your server!";
